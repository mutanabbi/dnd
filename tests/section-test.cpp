...
{
    {
        ...
        assert(true == reach({{13, 2}, {13, 2}}, {{14, 2}, {14, 2}}));
        assert(true == reach({{13, 2}, {13, 2}}, {{15, 2}, {15, 2}}));
        assert(true == reach({{13, 2}, {13, 2}}, {{16, 2}, {16, 2}}));
        assert(true == reach({{14, 2}, {14, 2}}, {{15, 2}, {15, 2}}));
        assert(true == reach({{14, 2}, {14, 2}}, {{16, 2}, {16, 2}}));
        ...
        assert(true == reach({{13, 3}, {13, 2}}, {{14, 3}, {14, 2}}));
        assert(true == reach({{13, 3}, {13, 2}}, {{15, 3}, {15, 2}}));
        assert(true == reach({{13, 3}, {13, 2}}, {{16, 3}, {16, 2}}));
        assert(true == reach({{14, 3}, {14, 2}}, {{15, 3}, {15, 2}}));
        assert(true == reach({{14, 3}, {14, 2}}, {{16, 3}, {16, 2}}));
        ...
        assert(true == reach({{14, 2}, {14, 2}}, {{13, 2}, {13, 2}}));
        assert(true == reach({{15, 2}, {15, 2}}, {{13, 2}, {13, 2}}));
        assert(true == reach({{16, 2}, {16, 2}}, {{13, 2}, {13, 2}}));
        assert(true == reach({{15, 2}, {15, 2}}, {{14, 2}, {14, 2}}));
        assert(true == reach({{16, 2}, {16, 2}}, {{14, 2}, {14, 2}}));
        ...
        assert(true == reach({{14, 3}, {14, 2}}, {{13, 3}, {13, 2}}));
        assert(true == reach({{15, 3}, {15, 2}}, {{13, 3}, {13, 2}}));
        assert(true == reach({{16, 3}, {16, 2}}, {{13, 3}, {13, 2}}));
        assert(true == reach({{15, 3}, {15, 2}}, {{14, 3}, {14, 2}}));
        assert(true == reach({{16, 3}, {16, 2}}, {{14, 3}, {14, 2}}));
